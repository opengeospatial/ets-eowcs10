# OGC Web Coverage Service 2.0.1 Earth Observation Application Profile Test-Suite

The OGC Web Coverage Service 2.0.1 Earth Observation Application Profile Test-Suite provides the Executable Test Script (ETS) to test implementations against the following specification(s):
  ...
  * [EOWCS] [OGC Web Coverage Service 2.0 Interface Standard - Earth Observation Application Profile](https://portal.opengeospatial.org/files/42722) (10-140r1)
  * Compliance Test Language (CTL) 0.5


Detailed information about this test suite is available [here](http://opengeospatial.github.io/ets-eowcs10/).
...
Issue tracker is available at [github](https://github.com/opengeospatial/ets-eowcs10/issues).
